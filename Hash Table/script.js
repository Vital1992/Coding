...
// The simplest implementation is using the Object data type. This is because all non-scalar objects in JavaScript behave as associative arrays, 
...
// Note: Key-value pairs must be set with the set method in order for the Map object to behave as expected. Using the syntax for Object above will appear to work, 
// but will not associate the key-value pair to its internal collection.
